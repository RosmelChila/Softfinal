    ...
    <AuthenticatedLayout>
        ...
        <div class="mb-4 inline-flex w-full overflow-hidden rounded-lg bg-white shadow-md">
            ...
            <div class="-mx-3 px-4 py-2">
                <div class="mx-3">
                    ...
                    <p class="text-sm text-gray-600">Usuarios del sistema</p>
                </div>
            </div>
        </div>
        ...
        <div class="inline-block min-w-full overflow-hidden rounded-lg shadow">
            ...
            :class="'px-4 py-2 bg-gray-800 text-white border rounded-md font-semibold text-xs'">
                <i class="fa-solid fa-ban">CREAR</i>
            </a>
                ...
                <tbody>
                    <tr class="text-gray-700">
                        <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">hola</p>
                        </td>
                        <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">oohla</p>
                        </td>
                        <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">dads</p>
                        </td>
                    </tr>
                </tbody>
            </table>
